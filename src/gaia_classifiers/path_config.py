...
DATASETS_DATA = {
    ...
    'moods_acoustic':     ['moods_claurier/audio/mp3/acoustic', 'moods_claurier/audio/mp3/not_acoustic'],
...
DATASETS_GROUNDTRUTH = {
    ...
    'moods_acoustic':     'moods_claurier/metadata/groundtruth_acoustic.yaml',
